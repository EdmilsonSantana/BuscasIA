...
public class EstacoesPuzzle extends Puzzle<Estacao> {
	...
	public static final String CSV_DISTANCIAS = "./estacoes/distancias.csv";

	public static final String CSV_MAPA = "./estacoes/mapa.csv";

	public static final String CSV_LINHAS = "./estacoes/linhas.csv";
