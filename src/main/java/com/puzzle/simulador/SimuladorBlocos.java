...
import com.puzzle.buscas.BuscaLargura;
import com.puzzle.modelo.Puzzle;
import com.puzzle.modelo.blocos.BlocosPuzzle;
import com.puzzle.modelo.blocos.MatrizQuadrada;

public class SimuladorBlocos extends SimuladorPuzzle<Puzzle<MatrizQuadrada>> {

	public SimuladorBlocos(AgentePuzzle agentePuzzle) {
		super(agentePuzzle);
	}
	...
	public static void main(String[] args) {
		AgentePuzzle agentePuzzle = new AgentePuzzle(new BuscaLargura());
